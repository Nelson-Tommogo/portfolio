        ...
        card.addEventListener("click", () => {
            if (card.classList.contains("web")) {
                ...
                portfolioView({
                    ...
                    project_brief: `This is HarvestHQ`,

                    project_date: "November 2023",
                    project_client: "School Project",
                    project_link: `www.${website}.co.ke`,
                ...
                portfolioView({
                    namePlate: card.querySelector(".title").textContent,
                    category: "SmartMavuno UI",
                    project_brief: `Smmart Mavuno Start Up UI/UX`,

                    project_date: "2021",
                    project_client: `${
                        card.querySelector(".title").textContent
                    } Corporation`,
                    project_link: `smartmavuno.co.ke`,
                ...
                portfolioView({
                    namePlate: card.querySelector(".title").textContent,
                    category: "IoT Web Interface for Waste",
                    project_brief: `Smart Web is a web interface for an IoT based system that seeks to solves waste issues in modern kenya`,
